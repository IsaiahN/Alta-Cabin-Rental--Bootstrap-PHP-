...
(function(e,t,n){"use strict";e.fn.foundationTabs=function(n){var r=e.extend({callback:e.noop},n),i=function(t){var n=t.closest("ul").find("li.active"),r=t.children("a").attr("href"),i=/^#/.test(r),s="";i&&(s=r+"Tab",s=s.replace(/^.+#/,"#"),e(s).closest(".tabs-content").children("li").removeClass("active").hide(),e(s).css("display","block").addClass("active")),n.removeClass("active"),t.addClass("active")};e(document).on("click.fndtn","ul.tabs li a",function(t){i(e(this).parent("li"))}),t.location.hash&&(i(e('a[href="'+t.location.hash+'"]').parent("li")),r.callback())}})(jQuery,this);
/*
